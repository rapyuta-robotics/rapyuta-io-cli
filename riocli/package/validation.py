...
REGEX_PATTERNS = {
    '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$': re.compile('^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)\\Z'),
                    ...
                    if data_is_dict:
                        ...
                        if "executables" in data_keys:
                            ...
                            if not isinstance(data__executables, (list, tuple)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".executables must be array", value=data__executables, name="" + (name_prefix or "data") + ".executables", definition={'type': 'array', 'items': {'type': 'object', 'properties': {'name': {'type': 'string'}, 'type': {'type': 'string', 'default': 'docker', 'enum': ['docker', 'build', 'preInstalled']}, 'command': {'type': 'string'}, 'runAsBash': {'type': 'boolean', 'default': True}}, 'required': ['type'], 'dependencies': {'type': {'oneOf': [{'properties': {'type': {'enum': ['docker']}, 'docker': {'type': 'object', 'properties': {'image': {'$ref': '#/definitions/imageName'}, 'pullSecret': {'$ref': '#/definitions/secretDepends'}}, 'required': ['image']}}}, {'properties': {'type': {'enum': ['build']}, 'build': {'type': 'object', 'properties': {'depends': {'$ref': '#/definitions/buildDepends'}}, 'required': ['depends']}}}, {'properties': {'type': {'enum': ['preInstalled']}}}]}}}}, rule='type')
                ...
                try:
                    ...
                    if data_is_dict:
                        ...
                        if "executables" in data_keys:
                            ...
                            data__executables = data["executables"]
                            if not isinstance(data__executables, (list, tuple)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".executables must be array", value=data__executables, name="" + (name_prefix or "data") + ".executables", definition={'type': 'array', 'items': {'type': 'object', 'properties': {'name': {'type': 'string'}, 'type': {'type': 'string', 'default': 'docker', 'enum': ['docker', 'build']}, 'command': {'type': 'string'}, 'runAsBash': {'type': 'boolean', 'default': True}, 'simulation': {'type': 'boolean', 'default': False}, 'limits': {'type': 'object', 'properties': {'cpu': {'type': 'number', 'min': 0.025, 'max': 8.0, 'multipleOf': 0.025}, 'memory': {'type': 'number', 'min': 128, 'max': 32768, 'multipleOf': 128}}}}, 'required': ['type'], 'dependencies': {'type': {'oneOf': [{'properties': {'type': {'enum': ['docker']}, 'docker': {'type': 'object', 'properties': {'image': {'$ref': '#/definitions/imageName'}, 'pullSecret': {'type': 'object', 'properties': {'depends': {'$ref': '#/definitions/secretDepends'}}, 'required': ['depends']}}, 'required': ['image']}}}, {'properties': {'type': {'enum': ['build']}, 'build': {'type': 'object', 'properties': {'depends': {'$ref': '#/definitions/buildDepends'}}, 'required': ['depends']}}}, {'properties': {'type': {'enum': ['preInstalled']}}}]}}}}, rule='type')
                            data__executables_is_list = isinstance(data__executables, (list, tuple))
                            if data__executables_is_list:
                                data__executables_len = len(data__executables)
                                for data__executables_x, data__executables_item in enumerate(data__executables):
                    ...
                    if data_is_dict:
                        ...
                        if "qos" in data_keys:
                            ...
                            if not isinstance(data__qos, (str)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".qos must be string", value=data__qos, name="" + (name_prefix or "data") + ".qos", definition={'type': 'string', 'enum': ['low', 'med', 'hi', 'max'], 'default': 'low'}, rule='type')
                            if data__qos not in ['low', 'med', 'hi', 'max']:
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".qos must be one of ['low', 'med', 'hi', 'max']", value=data__qos, name="" + (name_prefix or "data") + ".qos", definition={'type': 'string', 'enum': ['low', 'med', 'hi', 'max'], 'default': 'low'}, rule='enum')
                        else: data["qos"] = 'low'
...
def validate___definitions_cloudexecutablespec(data, custom_formats={}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object", value=data, name="" + (name_prefix or "data") + "", definition={'type': 'object', 'properties': {'name': {'type': 'string'}, 'type': {'type': 'string', 'default': 'docker', 'enum': ['docker', 'build']}, 'command': {'type': 'string'}, 'runAsBash': {'type': 'boolean', 'default': True}, 'simulation': {'type': 'boolean', 'default': False}, 'limits': {'type': 'object', 'properties': {'cpu': {'type': 'number', 'min': 0.025, 'max': 8.0, 'multipleOf': 0.025}, 'memory': {'type': 'number', 'min': 128, 'max': 32768, 'multipleOf': 128}}}}, 'required': ['type'], 'dependencies': {'type': {'oneOf': [{'properties': {'type': {'enum': ['docker']}, 'docker': {'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}, 'required': ['image']}}}, {'properties': {'type': {'enum': ['build']}, 'build': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'build', 'default': 'build'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}}, {'properties': {'type': {'enum': ['preInstalled']}}}]}}}, rule='type')
    data_is_dict = isinstance(data, dict)
    if data_is_dict:
        data_len = len(data)
        if not all(prop in data for prop in ['type']):
            raise JsonSchemaValueException("" + (name_prefix or "data") + " must contain ['type'] properties", value=data, name="" + (name_prefix or "data") + "", definition={'type': 'object', 'properties': {'name': {'type': 'string'}, 'type': {'type': 'string', 'default': 'docker', 'enum': ['docker', 'build']}, 'command': {'type': 'string'}, 'runAsBash': {'type': 'boolean', 'default': True}, 'simulation': {'type': 'boolean', 'default': False}, 'limits': {'type': 'object', 'properties': {'cpu': {'type': 'number', 'min': 0.025, 'max': 8.0, 'multipleOf': 0.025}, 'memory': {'type': 'number', 'min': 128, 'max': 32768, 'multipleOf': 128}}}}, 'required': ['type'], 'dependencies': {'type': {'oneOf': [{'properties': {'type': {'enum': ['docker']}, 'docker': {'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}, 'required': ['image']}}}, {'properties': {'type': {'enum': ['build']}, 'build': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'build', 'default': 'build'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}}, {'properties': {'type': {'enum': ['preInstalled']}}}]}}}, rule='required')
        if "type" in data:
                    ...
                    if data_is_dict:
                        ...
                        if "docker" in data_keys:
                            ...
                            if not isinstance(data__docker, (dict)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".docker must be object", value=data__docker, name="" + (name_prefix or "data") + ".docker", definition={'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}, 'required': ['image']}, rule='type')
                            ...
                            if data__docker_is_dict:
                                ...
                                if not all(prop in data__docker for prop in ['image']):
                                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".docker must contain ['image'] properties", value=data__docker, name="" + (name_prefix or "data") + ".docker", definition={'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}, 'required': ['image']}, rule='required')
                                ...
                                if "image" in data__docker_keys:
                                    ...
                                    validate___definitions_imagename(data__docker__image, custom_formats, (name_prefix or "data") + ".docker.image")
            ...
            if data_one_of_count8 != 1:
                raise JsonSchemaValueException("" + (name_prefix or "data") + " must be valid exactly by one definition" + (" (" + str(data_one_of_count8) + " matches found)"), value=data, name="" + (name_prefix or "data") + "", definition={'oneOf': [{'properties': {'type': {'enum': ['docker']}, 'docker': {'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}, 'required': ['image']}}}, {'properties': {'type': {'enum': ['build']}, 'build': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'build', 'default': 'build'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}}, {'properties': {'type': {'enum': ['preInstalled']}}}]}, rule='oneOf')
        data_keys = set(data.keys())
        if "name" in data_keys:
            data_keys.remove("name")
            data__name = data["name"]
        ...
        if "limits" in data_keys:
            ...
            if not isinstance(data__limits, (dict)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".limits must be object", value=data__limits, name="" + (name_prefix or "data") + ".limits", definition={'type': 'object', 'properties': {'cpu': {'type': 'number', 'min': 0.025, 'max': 8.0, 'multipleOf': 0.025}, 'memory': {'type': 'number', 'min': 128, 'max': 32768, 'multipleOf': 128}}}, rule='type')
            ...
            if data__limits_is_dict:
                ...
                if "cpu" in data__limits_keys:
                    ...
                    if not isinstance(data__limits__cpu, (int, float)) or isinstance(data__limits__cpu, bool):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".limits.cpu must be number", value=data__limits__cpu, name="" + (name_prefix or "data") + ".limits.cpu", definition={'type': 'number', 'min': 0.025, 'max': 8.0, 'multipleOf': 0.025}, rule='type')
                    if isinstance(data__limits__cpu, (int, float)):
                        quotient = Decimal(repr(data__limits__cpu)) / Decimal(repr(0.025))
                        if int(quotient) != quotient:
                            raise JsonSchemaValueException("" + (name_prefix or "data") + ".limits.cpu must be multiple of 0.025", value=data__limits__cpu, name="" + (name_prefix or "data") + ".limits.cpu", definition={'type': 'number', 'min': 0.025, 'max': 8.0, 'multipleOf': 0.025}, rule='multipleOf')
                if "memory" in data__limits_keys:
                    ...
                    if not isinstance(data__limits__memory, (int, float)) or isinstance(data__limits__memory, bool):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".limits.memory must be number", value=data__limits__memory, name="" + (name_prefix or "data") + ".limits.memory", definition={'type': 'number', 'min': 128, 'max': 32768, 'multipleOf': 128}, rule='type')
                    if isinstance(data__limits__memory, (int, float)):
                        quotient = data__limits__memory / 128
                        if int(quotient) != quotient:
                            raise JsonSchemaValueException("" + (name_prefix or "data") + ".limits.memory must be multiple of 128", value=data__limits__memory, name="" + (name_prefix or "data") + ".limits.memory", definition={'type': 'number', 'min': 128, 'max': 32768, 'multipleOf': 128}, rule='multipleOf')
    return data
...
def validate___definitions_imagename(data, custom_formats={}, name_prefix=None):
    if not isinstance(data, (str)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be string", value=data, name="" + (name_prefix or "data") + "", definition={'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, rule='type')
    if isinstance(data, str):
        if not REGEX_PATTERNS['^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'].search(data):
            raise JsonSchemaValueException("" + (name_prefix or "data") + " must match pattern ^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$", value=data, name="" + (name_prefix or "data") + "", definition={'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, rule='pattern')
    return data
...
def validate___definitions_deviceexecutablespec(data, custom_formats={}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException("" + (name_prefix or "data") + " must be object", value=data, name="" + (name_prefix or "data") + "", definition={'type': 'object', 'properties': {'name': {'type': 'string'}, 'type': {'type': 'string', 'default': 'docker', 'enum': ['docker', 'build', 'preInstalled']}, 'command': {'type': 'string'}, 'runAsBash': {'type': 'boolean', 'default': True}}, 'required': ['type'], 'dependencies': {'type': {'oneOf': [{'properties': {'type': {'enum': ['docker']}, 'docker': {'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['image']}}}, {'properties': {'type': {'enum': ['build']}, 'build': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'build', 'default': 'build'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}}, {'properties': {'type': {'enum': ['preInstalled']}}}]}}}, rule='type')
    data_is_dict = isinstance(data, dict)
    if data_is_dict:
        data_len = len(data)
        if not all(prop in data for prop in ['type']):
            raise JsonSchemaValueException("" + (name_prefix or "data") + " must contain ['type'] properties", value=data, name="" + (name_prefix or "data") + "", definition={'type': 'object', 'properties': {'name': {'type': 'string'}, 'type': {'type': 'string', 'default': 'docker', 'enum': ['docker', 'build', 'preInstalled']}, 'command': {'type': 'string'}, 'runAsBash': {'type': 'boolean', 'default': True}}, 'required': ['type'], 'dependencies': {'type': {'oneOf': [{'properties': {'type': {'enum': ['docker']}, 'docker': {'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['image']}}}, {'properties': {'type': {'enum': ['build']}, 'build': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'build', 'default': 'build'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}}, {'properties': {'type': {'enum': ['preInstalled']}}}]}}}, rule='required')
        if "type" in data:
                ...
                try:
                    ...
                    if data_is_dict:
                        ...
                        if "docker" in data_keys:
                            ...
                            data__docker = data["docker"]
                            if not isinstance(data__docker, (dict)):
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".docker must be object", value=data__docker, name="" + (name_prefix or "data") + ".docker", definition={'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['image']}, rule='type')
                            data__docker_is_dict = isinstance(data__docker, dict)
                            if data__docker_is_dict:
                                data__docker_len = len(data__docker)
                                if not all(prop in data__docker for prop in ['image']):
            ...
            if data_one_of_count10 != 1:
                raise JsonSchemaValueException("" + (name_prefix or "data") + " must be valid exactly by one definition" + (" (" + str(data_one_of_count10) + " matches found)"), value=data, name="" + (name_prefix or "data") + "", definition={'oneOf': [{'properties': {'type': {'enum': ['docker']}, 'docker': {'type': 'object', 'properties': {'image': {'type': 'string', 'pattern': '^([a-zA-Z0-9])([\\w.\\-_]+((?::\\d+|)(?=/[a-z0-9._-]+/[a-z0-9._-]+))|)(?:/|)([a-z0-9.\\-_]+(?:/[a-z0-9.\\-_]+|))(:([\\w.\\-_]{1,126})|)$'}, 'pullSecret': {'properties': {'kind': {'const': 'secret', 'default': 'secret'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['image']}}}, {'properties': {'type': {'enum': ['build']}, 'build': {'type': 'object', 'properties': {'depends': {'properties': {'kind': {'const': 'build', 'default': 'build'}, 'nameOrGUID': {'type': 'string'}, 'guid': {'type': 'string'}}}}, 'required': ['depends']}}}, {'properties': {'type': {'enum': ['preInstalled']}}}]}, rule='oneOf')
        data_keys = set(data.keys())
        if "name" in data_keys:
            data_keys.remove("name")
            data__name = data["name"]
